...
<head>
	...
	<?php
		if ($pageTitle == "Login" || $pageTitle == "Reset Your Password" || $pageTitle == "Reset Pending"){
	?>
        ...
        <header id="header">
			...
			<div id="control">
			    ...
			    ?> 
			                    ...
			                    <p>Angemeldet als <span class="username"><?php echo $_SESSION['Username'] ?></span> &bull; <a href="logout.php" class="button">Log out</a> &bull; <a href="prefs/index.php" class="button">Your Account</a></p> 
			    <?php }else{ ?> 
