...
<h1>Morpheus phpBB Style Notes</h1>
<p>
...
<br />
For support visit: <a href="http://www.phpbbstyles.com" target="main">http://www.phpbbstyles.com</a><br />
<br />
If you want your forum to run faster or if you want to see additional features of this style I recommend you use <a href="http://www.phpbbstyles.com/xs.php" target="_blank">eXtreme Styles mod</a> for phpBB.
<br />
<br />
Sincerely,<br />
