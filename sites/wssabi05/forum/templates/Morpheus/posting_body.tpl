...
<tr>
	<td class="nav" align="left" valign="middle"><span class="nav"><a href="{U_INDEX}">{L_INDEX}</a>
	<!-- BEGIN switch_not_privmsg -->
	&raquo;  <a href="{U_VIEW_FORUM}">{FORUM_NAME}</a> &raquo; {L_POST_A}
...
<tr> 
	...
	<td class="row" width="78%"><input type="text" name="subject" size="45" maxlength="60" style="width:98%" tabindex="2" class="post" value="{SUBJECT}" /></td>
</tr>
<tr> 
